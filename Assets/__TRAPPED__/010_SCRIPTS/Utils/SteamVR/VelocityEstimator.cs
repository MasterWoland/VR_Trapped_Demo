...
namespace Valve.VR.InteractionSystem
{
	...
	public class VelocityEstimator : MonoBehaviour
	{
		...
		private Transform _transform; // MRA: optimisation added by MRA
		...
		void Awake()
		{
			_transform = transform; // MRA: added by MRA
		...
		private IEnumerator EstimateVelocityCoroutine()
		{
			...
			while ( true )
			{
				...
				velocitySamples[v] = velocityFactor * ( _transform.position - previousPosition );
